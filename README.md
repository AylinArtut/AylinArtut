...
My thesis project aims to fully validate database models, including their semantics, attempting to solve this gap in both academic research and industry. The underlying algorithms for this project have been developed over the past three years alongside my studies and work. As an additional voluntary contribution, I plan to develop a standalone database modeling application tailored to this thesis, rather than relying on existing software.
