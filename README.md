...
[Last change: 11.03.26, ~19:18]

- [x] Ableitungen
  - [x] Becoming faster at solving
  - [x] Becoming faster at solving (with no fails)
  - [x] Kettenregel, Quotientenregel, Produktregel, L'Hospital
    - [x] Exponentialfunktionen (inkl. e-Funktion)
    - [x] Logarithmusfunktionen
    - [x] Trigonometrische Funktionen (Sinus, Cosinus, Tangens)
    - [x] Hyperbolische Funktionen (SinusH, CosinusH, TangensH)
